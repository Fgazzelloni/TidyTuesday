...
df %>% 
  ...
  scale_y_log10(expand=c(0,0),labels = label_number(scale_cut = cut_short_scale()))+
  ...
  labs(title = "Big Tech Stock Prices", y = "Stock Price",
       subtitle="Humans activity - Best Companies Mean Trend",
       caption="\nDataSource: #TidyTuesday 2023 week6 Big Tech Stock Prices\nDataViz: Federica Gazzelloni #30DayMapChallenge 2023 Day8 - humans\n") +
